          ...
          <div className="relative" style={{ width: "550px", height: "400px" }}>
            ...
            >
              <div
                ...
                style={{
                  left: peekMode ? "20px" : isLookingAtEachOther ? "55px" : `${45 + goldPos.faceX}px`,
                  top: peekMode ? "35px" : isLookingAtEachOther ? "65px" : `${40 + goldPos.faceY}px`,
                }}
              >
            ...
            <div
              ...
              style={{
                ...
                zIndex: 2,
                transform: peekMode ? "skewX(0deg)" : isLookingAtEachOther ? `skewX(${(darkPos.bodySkew || 0) * 1.5 + 10}deg) translateX(20px)` : (isTyping || hideEyes) ? `skewX(${(darkPos.bodySkew || 0) * 1.5}deg)` : `skewX(${darkPos.bodySkew || 0}deg)`,
                transformOrigin: "bottom center",
              }}
            >
              <div
                ...
                style={{
                  left: peekMode ? "10px" : isLookingAtEachOther ? "32px" : `${26 + darkPos.faceX}px`,
                  top: peekMode ? "28px" : isLookingAtEachOther ? "12px" : `${32 + darkPos.faceY}px`,
                }}
              >
            ...
            <div
              ...
              style={{
                ...
                zIndex: 3,
                transform: peekMode ? "skewX(0deg)" : `skewX(${bronzePos.bodySkew || 0}deg)`,
                transformOrigin: "bottom center",
              }}
            >
            ...
            <div
              ...
              style={{
                ...
                zIndex: 4,
                transform: peekMode ? "skewX(0deg)" : `skewX(${yellowPos.bodySkew || 0}deg)`,
                transformOrigin: "bottom center",
              }}
            >
      ...
      <div className="flex flex-1 items-center justify-center bg-background p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-10 text-center">
            <h1 className="mb-2 text-3xl font-bold tracking-tight">Content de vous revoir !</h1>
            <p className="text-sm text-muted-foreground">Entrez vos identifiants pour acceder a votre espace.</p>
          </div>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                autoComplete="email"
                required
                onFocus={() => { setIsTyping(true); setIsLookingAtEachOther(true); }}
                onBlur={() => { setIsTyping(false); setIsLookingAtEachOther(false); }}
                className="h-12 border-border/60 bg-background focus:border-ring"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 border-border/60 bg-background pr-10 focus:border-ring"
                />
                <button
                  type="button"
